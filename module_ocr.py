...
# set your access codes here before running
...
for filepath in image_files:
    ...
    try:
        ...
        prefix, gpc_block, four_digit, letter, h_digit = parseSerialFromResult(serial_result, sw)
...
def parseSerialFromResult(result, sw, debug=False):
    valid_prefixes = {'GPC', 'DBS', 'DSG'}
    block2_confusions = {'O': '0', 'C': '0', 'U': '0', 'Q': '0',
                         'I': '1', 'L': '1', 'N': '1', 'Z': '2', 'S': '5', 'G': '6', 'B': '8'}
    letter_confusions = {'I': '1', 'O': '0', 'S': '5', 'B': '8', 'G': '6', 'Z': '2', 'A': '4'}
